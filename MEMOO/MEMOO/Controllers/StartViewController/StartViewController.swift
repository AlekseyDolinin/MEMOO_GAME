...
class StartViewController: UIViewController, GADFullScreenContentDelegate {
    ...
    var listGame = ["fruit_", "emoji_", "color_", "animal_", "dinosaur_", "monster_", "alfred_", "animall_", "color_", "mandala_", "ninja_",  "sport_", "summer_", "toy_", "word_", "wordd_", "dog_", "toyy_", "vegetable_", "animalll_", "letter_"]
    var currentIndex = 0
